        ...
        <div className='flex flex-col w-[75vw] gap-0 h-[85vh] justify-center items-center mt-8 '>
            <div className='flex flex-row justify-between w-[70vw]'>
                <div className='flex flex-row h-fit mb-4'>
                      <button className=' text-xs p-1 px-6 rounded-xl bg-gray-100 active:bg-white'>All</button>
                     <button className='mx-5 text-xs p-1 px-6 rounded-xl bg-gray-100 active:bg-white'>New</button>
                     <button className='mx- text-xs p-1 px-6 rounded-xl bg-gray-100 active:bg-white'>Unsettled</button>
                     <button className='mx- text-xs p-1 px-6 rounded-xl bg-gray-100 active:bg-white'>Settled</button>
                </div>
            </div>
