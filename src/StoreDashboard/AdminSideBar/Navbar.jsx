...
<nav class="bg-white border-gray-200 px-2 sm:px-4 h-[60px] w-full rounded dark:bg-gray-900 z-10">
  ...
  <div class="flex md:order-2 w-[800px] mr-16">
    <button type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" class="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-pink-600 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1" >
    {searchIcon}
